...
// CONCATENATED MODULE: ./utils/withApollo.js
...
var withApollo_link = external_apollo_link_["ApolloLink"].from([httpLink]);
/* harmony default export */ var withApollo = (external_next_with_apollo_default()(function (_ref) {
  var ctx = _ref.ctx,
      headers = _ref.headers,
      initialState = _ref.initialState;
  return new external_apollo_client_default.a({
    cache: new external_apollo_cache_inmemory_["InMemoryCache"]().restore(initialState || {}),
    link: withApollo_link
  });
}));
  ...
  Object(createClass["a" /* default */])(MyApp, [{
    ...
    value: function () {
      ...
      regenerator_default.a.mark(function _callee(_ref) {
        var Component, router, ctx, pageProps, whitelist;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                _context.next = 10;
                return Object(requireSignedin["b" /* hasSignedIn */])(ctx);
              ...
              case 10:
                ...
                if (!whitelist.includes(ctx.pathname)) Object(redirectTo["a" /* default */])('/login', {
                  res: ctx.res,
                  status: 301
                });
