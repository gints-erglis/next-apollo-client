...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _document_SiteDocument; });
...
var _document_SiteDocument =
/*#__PURE__*/
function (_Document) {
  Object(inherits["a" /* default */])(SiteDocument, _Document);

  function SiteDocument() {
    Object(classCallCheck["a" /* default */])(this, SiteDocument);

    return Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(SiteDocument).apply(this, arguments));
  }

  Object(createClass["a" /* default */])(SiteDocument, [{
    key: "render",
    value: function render() {
      ...
      }), this.props.styleTags), external_react_default.a.createElement("body", null, external_react_default.a.createElement(next_document["Main"], null), external_react_default.a.createElement(next_document["NextScript"], null)));
    }
  }], [{
    key: "getInitialProps",
