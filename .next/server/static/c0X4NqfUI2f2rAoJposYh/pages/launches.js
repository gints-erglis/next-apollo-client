...
// CONCATENATED MODULE: ./api/launches/index.js
...
var GET_LAUNCH = external_graphql_tag_default()(_templateObject());

function Output(_ref) {
  var data = _ref.data;
  return external_react_default.a.createElement(card_default.a, {
    title: "Users",
    extra: external_react_default.a.createElement(button_default.a, {
    ...
    className: "mycard"
  }, data.loading ? external_react_default.a.createElement(spin_default.a, {
    indicator: antIcon
    ...
    renderItem: function renderItem(item) {
      return external_react_default.a.createElement(list_default.a.Item, null, external_react_default.a.createElement("p", null, item.id), external_react_default.a.createElement("p", null, item.url));
    }
  }));
}

var FeedWithData = Object(external_react_apollo_["graphql"])(external_graphql_tag_default()(_templateObject2()), {
  options: {
    notifyOnNetworkStatusChange: true
  }
})(Output);

var launches_Launch = function Launch() {
  return external_react_default.a.createElement(FeedWithData, null);
};

/* harmony default export */ var launches = (launches_Launch);
// EXTERNAL MODULE: ./utils/requireSignedin.js + 1 modules
var requireSignedin = __webpack_require__("lgLq");
...
var launches_Default =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(Default, _React$Component);

  function Default() {
    Object(classCallCheck["a" /* default */])(this, Default);

    return Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Default).apply(this, arguments));
  }

  Object(createClass["a" /* default */])(Default, [{
    key: "render",
    value: function render() {
      ...
      return external_react_default.a.createElement(Main["a" /* default */], null, external_react_default.a.createElement(launches, null));
    }
  }]);
...
/* harmony default export */ var pages_launches = __webpack_exports__["default"] = (Object(requireSignedin["a" /* default */])(launches_Default));
