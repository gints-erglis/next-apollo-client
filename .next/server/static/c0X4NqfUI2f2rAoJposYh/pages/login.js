...
// EXTERNAL MODULE: ./utils/redirectTo.js
var redirectTo = __webpack_require__("Oq0r");
...
var LOGIN_MUTATION = external_graphql_tag_default()(_templateObject());

var Login_LoginForm =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(LoginForm, _Component);
  ...
  function LoginForm() {
    ...
    Object(classCallCheck["a" /* default */])(this, LoginForm);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(LoginForm)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleChange", function (e) {
      ...
      var val = type === 'number' ? parse_float_default()(value) : value;

      _this.setState(Object(defineProperty["a" /* default */])({}, name, val));
    });

    return _this;
  }

  Object(createClass["a" /* default */])(LoginForm, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement(row_default.a, {
        ...
        }, external_react_default.a.createElement(form_default.a.Item, null, getFieldDecorator('email', {
          rules: [{
            required: true,
        ...
        }))), external_react_default.a.createElement(form_default.a.Item, null, getFieldDecorator('password', {
          rules: [{
            required: true,
          ...
          onChange: _this2.handleChange
        }))), external_react_default.a.createElement(form_default.a.Item, null, external_react_default.a.createElement(button_default.a, {
          type: "primary",
          htmlType: "submit",
          className: "login-form-button"
        }, "Log in"), external_react_default.a.createElement("p", null, external_react_default.a.createElement("a", {
          className: "login-form-forgot",
          href: ""
        }, "Forgot password"), " Or ", external_react_default.a.createElement("a", {
          href: "/register"
        }, "register now!")))), loading && external_react_default.a.createElement(spin_default.a, {
          indicator: antIcon
        }), error && external_react_default.a.createElement("p", null, "Error :( Please try again")));
      });
    }
  }]);
...
var Login = form_default.a.create({
  name: 'normal_login'
})(Login_LoginForm);
...
/* harmony default export */ var pages_login = __webpack_exports__["default"] = (function () {
  return external_react_default.a.createElement(Main["a" /* default */], null, external_react_default.a.createElement(components_Login, null));
});
...
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("20a2");
