...
// EXTERNAL MODULE: external "react-apollo/index"
var index_ = __webpack_require__("gbmr");

// EXTERNAL MODULE: ./utils/redirectTo.js
var redirectTo = __webpack_require__("Oq0r");

// CONCATENATED MODULE: ./components/Login/logout.js
...
var LOGOUT = external_graphql_tag_default()(_templateObject());
...
function Output(_ref) {
  ...
  if (data.loading) {
    content = external_react_default.a.createElement(spin_default.a, {
      indicator: antIcon
    });
  } else {
    if (data.logout.ok) {
      ...
      content = external_react_default.a.createElement("p", null, "Error!");
    }
  }
...
var DoLogout = Object(index_["graphql"])(LOGOUT, {
  options: {
    notifyOnNetworkStatusChange: true
  }
})(Output);

var logout_Logout = function Logout() {
  return external_react_default.a.createElement(DoLogout, null);
};

/* harmony default export */ var logout = (logout_Logout);
// CONCATENATED MODULE: ./pages/logout.js



/* harmony default export */ var pages_logout = __webpack_exports__["default"] = (function () {
  return external_react_default.a.createElement(Main["a" /* default */], null, external_react_default.a.createElement(logout, null));
});
...
module.exports = require("react-apollo/index");
